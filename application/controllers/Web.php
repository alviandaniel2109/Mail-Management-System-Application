...
class Web extends CI_Controller {
	...
	{
		$ceks = $this->session->userdata('surat_menyurat@Proyek-2020');
		if(!isset($ceks)) {
			redirect('web/login');
		}else{
					redirect('users');
								 ...
								 redirect('web/login');
										 ...
										 if($cekpass <> $pass) {
												...
												redirect('web/login');
																...
																$this->session->set_userdata('surat_menyurat@Proyek-2020', "$cekun");
																$this->session->set_userdata('id_user@Proyek-2020', "$row->id_user");
	...
	public function logout() {
     if ($this->session->has_userdata('surat_menyurat@Proyek-2020') and $this->session->has_userdata('id_user@Proyek-2020')) {
